...
const AuthHeader = () => {
  ...
  const buttonStyle = "border-solid border-2 border-md border-white rounded-md p-2 text-sm hover:bg-white hover:text-text active:bg-maindarker active:text-white"
    return (
        <>
